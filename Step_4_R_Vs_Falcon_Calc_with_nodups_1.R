...
LIMIT_BASED_WHITELIST <- read_excel("//inhadfil101.in.standardchartered.com/wkgrps5/RAC_IN_MIS/Sumeet/R_Simulation/Hotlist/LIMIT_BASED_WHITELIST.xls")
...
FALT002_count1_data = sqldf(paste0("Select * from FALT002 WHERE ", "trn_dt1 >= '" , dt, " '"))
...
FALT002_count2_data = sqldf(paste0("Select * from FALT002 WHERE ", "trn_dt1 <= '" , dt, " '"))
...
FALT003_count1_data = sqldf(paste0("Select * from FALT003 WHERE ", "trn_dt1 >= '" , dt, " '"))
...
FALT003_count2_data = sqldf(paste0("Select * from FALT003 WHERE ", "trn_dt1 <= '" , dt, " '"))
...
output_file_name = paste0("//inhadfil101.in.standardchartered.com/wkgrps5/RAC_IN_MIS/Sumeet/R_Simulation/Results/",Original_Rule_Name,"_",Rule_counter,"_",Today,".xlsx",collapse="")
# print(output_file_name)

# To write oputput Nos. only for the specific rule
Rule_Output = sqldf(paste0("Select * from output WHERE ", "Rule_Name = ","'", output[i,1],"'"))
# print(Rule_Output)
