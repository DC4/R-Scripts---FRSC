...
Country_Txn_Data_1$EXP_CARDS_15MIN_CNT <- as.numeric(as.character(Country_Txn_Data_1$EXP_CARDS_15MIN_CNT))
Country_Txn_Data_1$EXP_CARDS_15MIN_AMT <- as.numeric(as.character(Country_Txn_Data_1$EXP_CARDS_15MIN_AMT))
