...
g <- "Type"
h <- "Today"
colnames(output) <- c(a,b,c,d,e,f,g,h)
...
# dt1 <- format(as.Date(Sys.Date() - 1), format = "%d-%m-%Y")
# print(dt1)
# dt2 <- format(as.Date(Sys.Date() - 2), format = "%d-%m-%Y")
# print(dt2)
...
# export(UDV_Calculation_Table_Ref_2,paste0("//inhadfil101.in.standardchartered.com/wkgrps5/RAC_IN_MIS/Sumeet/R_Simulation/","UDV_Calculation_Table_Ref_2","_",Today,".xlsx",collapse=""),which="UDV_Calculation_Table_Ref_2")


# Debug <- subset(Country_Txn_Data_1, ACCT_NBR == 5523438414705870 | ACCT_NBR == 5523438413458117)

# Exporting Debug results to local for reference
# export(Country_Txn_Data_1,paste0("//inhadfil101.in.standardchartered.com/wkgrps5/RAC_IN_MIS/Sumeet/R_Simulation/","Country_Txn_Data_1","_",Today,".xlsx",collapse=""),which="Country_Txn_Data_1")

# # Record Check
# Check <- sqldf("SELECT DISTINCT FI_TRANSACTION_ID, * FROM Country_Txn_Data_1 WHERE 
# FI_TRANSACTION_ID IN ('1f605b06da006d00',
# '1e605b06da00417b',
# '006059e72a008e90',
# '006059e72a008f48',
# '20605b06da00e3f7') ORDER BY FI_TRANSACTION_ID ASC;")

# Check_acctnbr <- sqldf("SELECT ACCT_NBR,FI_TRANSACTION_ID,TRN_AUTH_POST,AUTH_DECISION_XCD,
# TRN_POS_ENT_CD,TRN_TYP,SRVC_UDV_CNP_HOURLY_TIME,SRVC_UDV_CNP_HOURLY_CNT,
# SRVC_UDV_CNP_HOURLY_AMT,USD,cnty,* FROM Country_Txn_Data_1 WHERE 
# ACCT_NBR IN (
# '4325650270092341',
# '4509360641347600',
# '4509360650463595',
# '5523438412440389'
# ) ORDER BY FI_TRANSACTION_ID ASC;")

# Exporting Check results to local for reference
# export(Check,paste0("//inhadfil101.in.standardchartered.com/wkgrps5/RAC_IN_MIS/Sumeet/R_Simulation/","Check","_",Today,".xlsx",collapse=""),which="Check")
# export(Check_acctnbr,paste0("//inhadfil101.in.standardchartered.com/wkgrps5/RAC_IN_MIS/Sumeet/R_Simulation/","Check_acctnbr","_",Today,".xlsx",collapse=""),which="Check_acctnbr")
