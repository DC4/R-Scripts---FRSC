  ...
  
{
 ...
 # This is obtianed initially before in the code as in Transaction data
 ...
 # cntrylist <- c('ZM','TW')
  ...
  for (cty in cntrylist)
  {
	...
	#squery <- paste0("select * ","from falt003_",tolower(cty),"_",tolower(dbn),
	#collapse = "")
...
#substr(strsplit(CLIENT_XID, "_")[[1]][2],a,b)
...
# Head of Country_Rule_Data
head(Country_Rule_Data)
# Tail of Country_Rule_Data
tail(Country_Rule_Data)
# Unique Txn dates present in FALT003 date
unique(Country_Rule_Data$trn_dt1)
# export(Country_Rule_Data,"//inhadfil101.in.standardchartered.com/wkgrps7/RAC_IN_MIS/Dinesh/Country_Rule_Data.xlsx")
