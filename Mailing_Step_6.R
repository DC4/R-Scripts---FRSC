...
df7 <- print(xtable(output, align="ccccccccc"), # align columns
...
send.mail(from="mis.frsc@sc.com",
		  ...
		  # cc=c("Dinesh.Charan@sc.com"),
            cc = c("sumeet.kumar@sc.com","Srinadhareddy.Tatiparthi@sc.com","Saikat.De@sc.com","Abhishek.Bhatia1@sc.com","Jhilam.Manna@sc.com","Ajanta.Dhilipkumarbehera@sc.com","Dinesh.Charan@sc.com"),
            to = c("Saravanakumar.K@sc.com","Anishramkrishnan.Iyer@sc.com"),
		  subject=paste0("UAT - R Simulation results as on ",dt),
          body=df8,
          html=TRUE,
