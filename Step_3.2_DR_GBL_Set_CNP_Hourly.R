...
Country_Txn_Data_2$DR_GBL_SRVC_UDV_CNP_HOURLY_CNT <- as.numeric(as.character(Country_Txn_Data_2$DR_GBL_SRVC_UDV_CNP_HOURLY_CNT))
Country_Txn_Data_2$DR_GBL_SRVC_UDV_CNP_HOURLY_AMT <- as.numeric(as.character(Country_Txn_Data_2$DR_GBL_SRVC_UDV_CNP_HOURLY_AMT))
